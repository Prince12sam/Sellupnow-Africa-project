...
class SupportTicketController extends Controller
{
    ...
    /**
     * GET /api/client/support/getTicket/{id}
     * Show a single ticket by numeric ID.
     */
    public function showById(Request $request, $id)
    {
        $ticket = SupportTicketRepository::query()
        ...
        return $this->json('support ticket details', [
            'support_ticket'  => SupportTicketDetailsResource::make($ticket),
            'messages'        => SupportTicketMessageResource::collection($messages),
        ]);
    }

    /**
     * POST /api/client/support/replyTicket/{id}
     * Append a user message to the ticket.
     */
    ...
    {        $request->validate([
        ...
        return $this->json('reply sent successfully', [
            'message' => SupportTicketMessageResource::make($message),
        ]);
    }
}
