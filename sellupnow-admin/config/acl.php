...
return [
    'permissions' => [
        ...
        'admin' => [
            ...
            'homepageHero' => ['edit', 'update'],
            'flashSaleWidget' => ['edit', 'update'],
            'reelAdPlacement' => ['index', 'store', 'update', 'destroy'],
            ...
            'listingModeration' => ['index', 'show', 'status', 'publish', 'delete', 'featured'],
