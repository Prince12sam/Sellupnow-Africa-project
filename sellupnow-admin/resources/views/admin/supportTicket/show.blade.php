    ...
    <script>
        ...
        $('#replyForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(e) {
                    ...
                    $('.send-btn').removeAttr('disabled');
                    $('.send-btn').html('<i class="fa fa-paper-plane"></i>');
                    const errorMessage = e?.responseJSON?.message || "{{ __('Failed to send message') }}";
        ...
        const fetchMessages = () => {
            ...
            $.ajax({
                ...
                error: function() {
                    if (typeof toastr !== 'undefined') {
                        toastr.error("{{ __('Failed to fetch latest messages') }}");
                    }
                }
            });
        }
            ...
            messages.forEach(message => {
                ...
                const messageElement = `
                    ...
                    <div class="message_item_content">
                            ...
                            <div class="message_item_text">
                                <a class="pinBtn" href="${pinLink}" title="${message.is_highlighted ? 'Unpin' : 'Pin' } this message">
                                    <i class="bi bi-pin-angle"></i>
                                </a>
                                ${ messageWithClickableLink }
                            </div>
