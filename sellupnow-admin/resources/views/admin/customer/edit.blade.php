                                        ...
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                <x-input label="First Name" name="name" type="text"
                                                    placeholder="Enter Name" required="true" :value="$customer->name" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mt-3">
                                                <x-input label="Last Name" name="last_name" type="text"
                                                    placeholder="Enter Name" :value="$customer->last_name" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="dropzone-container">
                                        <label for="thumbnail" class="mainThumbnail">
                                            <img src="{{ $customer->thumbnail ?? 'https://placehold.co/500x500/png' }}" id="preview" alt=""
                                    ...
                                    <div class="mt-3">
                                        ...
                                        placeholder="Enter Date of Birth" :value="$customer->date_of_birth" />
                                    </div>
                                </div>
                            </div>
                        </div>
