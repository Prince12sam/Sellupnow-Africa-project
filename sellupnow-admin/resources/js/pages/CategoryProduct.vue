                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <img
                                                                            ...
                                                                            "
                                                                            class="w-5 h-5"
                                                                            src="/assets/icons/rating/5-star.svg"
                                                                            alt=""
                                                                        />
                                                                        <img
                                                                            v-if="
                                                                            ...
                                                                            "
                                                                            class="w-5 h-5"
                                                                            src="/assets/icons/rating/4-star.svg"
                                                                            alt=""
                                                                        />
                                                                        <img
                                                                            v-if="
                                                                            ...
                                                                            "
                                                                            class="w-5 h-5"
                                                                            src="/assets/icons/rating/3-star.svg"
                                                                            alt=""
                                                                        />
                                                                        <img
                                                                            v-if="
                                                                            ...
                                                                            "
                                                                            class="w-5 h-5"
                                                                            src="/assets/icons/rating/2-star.svg"
                                                                            alt=""
                                                                        />
                                                                        <img
                                                                            v-if="
                                                                            ...
                                                                            "
                                                                            class="w-5 h-5"
                                                                            src="/assets/icons/rating/1-star.svg"
                                                                            alt=""
                                                                        />
                                                                    </div>
                                                                </div>
