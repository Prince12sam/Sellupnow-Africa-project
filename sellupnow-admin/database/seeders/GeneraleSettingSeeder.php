...
class GeneraleSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        GeneraleSetting::create([
            ...
            'footer_description' => 'Sellupnow is your trusted online shop for fresh groceries, perfumes, and daily essentials. We deliver quality products at the best prices—right to your doorstep.',
            'footer_logo_id' => null,
