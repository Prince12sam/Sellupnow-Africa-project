...
class ReelReportDialog extends StatelessWidget {
  final VoidCallback? onTap;
  final TextEditingController? controller;
  const ReelReportDialog({super.key, this.onTap, this.controller});
      ...
      child: Material(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Please provide additional details about why you're reporting this video...",
