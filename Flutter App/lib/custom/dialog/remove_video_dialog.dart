...
class RemoveVideoDialog extends StatelessWidget {
  ...
  const RemoveVideoDialog({super.key, this.onTap});
      ...
      child: Material(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(EnumLocale.txtDoYouWantToSureRemoveThisVideo.name.tr,
            ...
            Text(EnumLocale.txtDeleteVideoDescription.name.tr,
