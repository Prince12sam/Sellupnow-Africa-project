...
import 'package:listify/ui/popular_poduct_screen/widget/popular_product_screen_widget.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: Row(
          ...
          children: [
            GetBuilder<PopularProductScreenController>(builder: (controller) {
      ...
      appBar: AppBar(
        ...
        flexibleSpace: PopularProductScreenAppBar(
          title: EnumLocale.txtPopularProduct.name.tr,
        ),
      ),
      body: GetBuilder<PopularProductScreenController>(
